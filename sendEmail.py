...
<html lang="en">
  ...
  <body style="font-family: 'PT Sans', sans-serif;">
    ...
    <p>Stay safe and indoors.</p>
        ...
        """.format(data['bangaloreCount'], data['mangaloreCount'], data['udupiCount'], data["shimogaCount"], data["mysoreCount"], data["kodaguCount"], data["karnatakaCount"], data['kasargodCount'], data["wayanadCount"], data["mangaloreDeath"], data["mysoreDeath"], data["shimogaDeath"], data["kodaguDeath"], data["mangaloreVaccinations"], data["karnatakaVaccinations"], data["keralaVaccinations"], data['indiaDailyConfirmed'])
